...
voce poderá gerenciar todas as operações que gostaria de fazer, relacionada a sua função.

Na aba gerente, encontrará vários gerenciamentos de contas, desde criar uma nova conta para um cliente, até listar todas as contas do banco.

Na aba cliente, voce poderá fazer as operações básicas de um simples banco como: débito, crédito, excluir conta, ver saldo e ver extrato.
