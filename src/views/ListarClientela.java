 ...
 * @author T-Gamer
 */
public class ListarClientela extends javax.swing.JFrame {

    /**
     * Creates new form ListarClientela
     */
    public ListarClientela() {
        initComponents();
        control = new ControllerListarClientes(this);
    }

    public ControllerListarClientes getControl() {
        return control;
    }

    public void setControl(ControllerListarClientes control) {
    ...
    private void initComponents() {
        ...
        jTable.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "CPF", "Saldo", "Conta Salario", "Conta Corrente", "Conta Poupanca"
            }
        ) {
...
//            java.util.logging.Logger.getLogger(ListarClientela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new ListarClientela().setVisible(true);
//            }
//        });
//    }
